<h3 class="text-primary">Adicionar taxa</h3>
<hr>
<form action="<?= base_url('taxas/salvar'); ?>" method="post">
    <div class="row">
        ...
        <div class="form-group col-sm-4">
            ...
            <input type="text" name="valor" id="valor" class="form-control money" required="">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-3">
            <label for="gratuidade">Gratuidade</label>
            <input type="number" name="gratuidade" id="gratuidade" class="form-control" min="0" value="0" required="">
        </div>
        <div class="form-group col-sm-3">
